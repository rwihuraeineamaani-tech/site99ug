...
## Goal
Replace the current Sales placeholder with a complete commercial workspace covering new leads, existing-client growth, and partnerships—from first contact through an approved offer, signed contract, invoicing, and client onboarding.
...
- **Opportunities** — full opportunity record with client/prospect, owner, assigned collaborators, source, service, probability, value, expected close, next action, activity history, files, notes, and loss reason.
...
Lead / existing client / partner
  ...
  → won opportunity
  → resident/client record + invoice + onboarding tasks
```

- Link prospects to an existing resident/client when applicable, without duplicating records.
...
- On a won deal, create or link the resident/client, retain the full sales history, prepare an invoice in Finance, and generate onboarding tasks.
- Support renewals, upsells, retainers, and repeat projects against existing residents/clients.
...
- Add normalized tables for leads/contacts, opportunities, assignments, activities, follow-ups, rate cards, offers, offer versions, line items, and sales targets.
...
- Reuse current resident/client, Legal contract/partnership, Finance invoice, Calendar, Chat, To-Do, and dashboard infrastructure rather than creating parallel records.
- Keep issued offer versions immutable so the approved PDF always matches the reviewed data.

## Verification
- Test new lead, existing-client upsell, and partnership journeys end to end.
- Verify assignment visibility, follow-up reminders, Founder approval, Legal handoff, invoice preparation, and won-client conversion.
