  ...
  return (
    <Layout>
      ...
      <section className="border-t border-border">
        <div className="grid grid-cols-12 mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground border-b border-border px-8 md:px-16 py-4">
        ...
        {residents.map((r, i) => (
          <motion.a
            ...
            className="grid grid-cols-12 items-center border-b border-border px-8 md:px-16 py-6 md:py-8 group hover:bg-site-red transition-colors duration-300"
          >
      ...
      <section className="px-8 md:px-16 py-32 grid md:grid-cols-3 gap-10 border-t border-border">
        {[
