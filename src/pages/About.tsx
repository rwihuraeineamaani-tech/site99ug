...
export default function About() {
  return (
    <Layout>
      ...
      <section className="border-t border-border px-8 md:px-16 py-16 md:py-24">
      ...
      <section className="px-8 md:px-16 py-16 md:py-24 text-center border-t border-border">
