  ...
  return (
    <AppShell eyebrow="Client portal">
      ...
      <PageHeader
        ...
        actions={client ? <><Link to="/portal/chat"><Button size="sm" className="gap-2"><MessageCircle className="h-4 w-4" /> Chat</Button></Link><StatusChip value={client.status} /></> : undefined}
      />
