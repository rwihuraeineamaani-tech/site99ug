...
export const Footer = () => (
  <footer className="border-t border-border bg-background text-foreground">
    <div className="px-4 md:px-6 py-12 md:py-16 grid grid-cols-2 md:grid-cols-4 gap-8 label">
    ...
    <div className="border-t border-border px-4 md:px-6 py-5 flex flex-col md:flex-row justify-between gap-2 label text-[11px] text-muted-foreground">
